...
class Pedido():
    def crearPedido(conexion, producto, cantidad, precio_uni, precio_total):
        try:
            with conexion.cursor() as cursor:
                consulta = "INSERT INTO detalle_pedido(producto, cantidad, precio_uni, precio_total) VALUES (%s, %s, %s, %s);"
                cursor.execute(consulta, (producto, cantidad, precio_uni, precio_total))
            conexion.commit()
            return True
